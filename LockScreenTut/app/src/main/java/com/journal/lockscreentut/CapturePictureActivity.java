...
//        firebaseStorage = FirebaseStorage.getInstance();
    ...
    private File getPictureFile() throws IOException {
        ...
        String pictureFile = "journal" + timeStamp;
    ...
    private void addToGallery() {
        ...
        //Create intent of the form and send the image URI
        String key = "key";
        Intent myIntent = new Intent(CapturePictureActivity.this, AddActivity.class);
        myIntent.putExtra(key, f.toString()); //Optional parameters
        CapturePictureActivity.this.startActivity(myIntent);
